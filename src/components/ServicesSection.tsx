  ...
  const services = [
    {
      ...
      highlights: [
        'Cross-platform development for faster time-to-market',
    ...
    },
    {
      ...
      highlights: [
        ...
        'Live service and content management'
      ]
    },
    {
      id: 'ui-ux',
    ...
    },
    {
      ...
      highlights: [
        'Cross-platform AR/VR applications',
        ...
        'Performance optimization for VR headsets'
      ]
    },
    {
      id: 'data-analytics',
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {service.technologies.map((tech, idx) => (
                            <span
                              key={idx}
                              className="px-3 py-1 bg-brand-primary/10 text-brand-primary rounded-full text-sm font-medium border border-brand-primary/20"
                            >
                              {tech}
                            </span>
                          ))}
