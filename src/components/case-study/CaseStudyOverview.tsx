        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {project.techStack.map((stack, index) => <div key={index} className="bg-gray-800/30 rounded-xl p-6 border border-gray-700/30">
                  <h4 className="text-cyan-400 font-semibold mb-4">{stack.category}</h4>
                  <div className="space-y-2">
                    {stack.technologies.map((tech, techIndex) => <div key={techIndex} className="text-gray-300 text-sm">
                        {tech}
                      </div>)}
                  </div>
                </div>)}
