      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">
            Project <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Overview</span>
          </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {project.techStack.map((stack, index) => (
                <div key={index} className="bg-gray-800/30 rounded-xl p-6 border border-gray-700/30">
                  <h4 className="text-blue-400 font-semibold mb-4">{stack.category}</h4>
