      ...
      <div className="relative z-20 container mx-auto px-6 py-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className={`font-heading text-6xl md:text-8xl font-bold mb-8 text-white ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
            Engineering the 
            <span className="block bg-gradient-to-r from-slate-400 via-stone-400 to-zinc-400 bg-clip-text text-transparent">
              Future. Today.
            </span>
          </h1>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto ${isVisible ? 'animate-fade-in-up animate-stagger-3' : 'opacity-0'}`}>
            <div className="text-center group">
              <div className="w-16 h-16 bg-gray-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-slate-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-zinc-500/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <CheckCircle className="h-8 w-8 text-zinc-300" />
              </div>
