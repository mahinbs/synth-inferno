...
const ServiceCardActionButtons = memo(({ learnMorePath, serviceTitle }: ServiceCardActionButtonsProps) => {
  ...
  return (
    <div className="flex space-x-4 pt-4">
      <Link
        to={learnMorePath}
        className="flex-1 inline-flex items-center justify-center px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-medium transition-all duration-400 shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
