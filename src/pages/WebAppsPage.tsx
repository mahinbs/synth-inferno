import { Code, Globe, Zap, Shield, Users, TrendingUp, CheckCircle, Star, ArrowRight, Cpu, Database, Cloud, Layers, Lock, Rocket } from 'lucide-react';
...
const WebAppsPage = () => {
  ...
  const capabilities = [
    {
      ...
      description: 'End-to-end web application development from database design to user interface, ensuring seamless integration across all layers.',
      highlight: 'Complete Solutions'
    },
    {
      icon: Globe,
      title: 'Universal Accessibility',
      description: 'Responsive, progressive web applications that work flawlessly across all devices, browsers, and accessibility standards.',
      highlight: 'Cross-Platform'
    },
    {
      icon: Zap,
      title: 'Performance Excellence',
      description: 'Lightning-fast applications optimized for speed with advanced caching, code splitting, and performance monitoring.',
      highlight: 'Blazing Fast'
    },
    {
      icon: Shield,
      title: 'Enterprise Security',
      description: 'Bank-grade security with multi-layer protection, data encryption, and comprehensive security auditing.',
      highlight: 'Fort Knox Secure'
    },
    {
      icon: Users,
      title: 'Infinite Scalability',
      description: 'Architecture designed to grow with your business, handling millions of users with automatic scaling capabilities.',
      highlight: 'Scale to Millions'
    },
    {
      icon: TrendingUp,
      title: 'Intelligence Built-In',
      description: 'Integrated analytics, AI capabilities, and business intelligence to drive data-driven decisions and growth.',
  ...
  const solutions = [
    {
      ...
      description: 'Next-generation online stores with AI-powered recommendations, real-time inventory, and seamless payment processing.',
      features: ['Smart Product Recommendations', 'Multi-Currency Support', 'Advanced Analytics', 'Mobile-First Design'],
      color: 'from-blue-500 to-cyan-500'
    },
    {
      category: 'Business Management Systems',
      description: 'Comprehensive ERP and CRM solutions that streamline operations and boost productivity across all departments.',
      features: ['Workflow Automation', 'Real-Time Reporting', 'Team Collaboration', 'API Integrations'],
      color: 'from-purple-500 to-pink-500'
    },
    {
      category: 'Data Visualization Dashboards',
      description: 'Interactive dashboards that transform complex data into actionable insights with beautiful, intuitive interfaces.',
      features: ['Real-Time Data', 'Custom Visualizations', 'Export Capabilities', 'Role-Based Access'],
      color: 'from-green-500 to-emerald-500'
    },
    {
      category: 'Social & Community Platforms',
      description: 'Engaging social applications with real-time messaging, content sharing, and community building features.',
      features: ['Real-Time Chat', 'Content Management', 'User Profiles', 'Moderation Tools'],
  ...
  const technologies = [
    {
      ...
      description: 'Modern, interactive user interfaces that captivate and engage'
    },
    {
    ...
    },
    {
      ...
      icon: Cloud,
      technologies: ['AWS', 'Google Cloud', 'Docker', 'Kubernetes', 'CloudFlare'],
      description: 'Scalable cloud solutions for global reach and reliability'
    },
    {
      category: 'AI Integration',
      icon: Cpu,
      technologies: ['OpenAI', 'TensorFlow', 'Machine Learning', 'Natural Language Processing'],
  ...
  const developmentProcess = [
    ...
    },
    {
      ...
      duration: '2-3 weeks',
      description: 'Creating intuitive user experiences and stunning visual designs that align with your brand identity.',
      deliverables: ['UI/UX Design', 'Interactive Prototypes', 'Design System']
    },
    {
      phase: 'Development & Integration',
      duration: '6-12 weeks',
      description: 'Building your application with clean, maintainable code and seamless third-party integrations.',
      deliverables: ['Core Development', 'API Integration', 'Database Setup']
    },
    {
      phase: 'Testing & Optimization',
      duration: '1-2 weeks',
      description: 'Comprehensive testing across devices, browsers, and performance optimization for peak efficiency.',
      deliverables: ['Quality Assurance', 'Performance Testing', 'Security Audit']
    },
    {
      phase: 'Launch & Support',
      duration: 'Ongoing',
      description: 'Smooth deployment with monitoring, maintenance, and continuous improvement based on user feedback.',
      deliverables: ['Production Deployment', '24/7 Monitoring', 'Ongoing Support']
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white" style={{
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              Transform your business with intelligent web applications that combine cutting-edge technology, 
              stunning design, and seamless user experiences. From concept to deployment, we craft digital solutions 
      ...
      <section className="py-24 bg-gray-900/70 backdrop-blur-sm">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold mb-6">Why Choose Synth Inferno?</h2>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              We don't just build web applications – we engineer digital masterpieces that transform businesses 
              and create lasting impact in the digital landscape.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {capabilities.map((capability, index) => (
              <div key={index} className="group relative p-8 rounded-3xl bg-gray-800/60 border border-gray-700/50 hover:border-blue-400/50 transition-all duration-500 overflow-hidden backdrop-blur-sm">
                {/* Background Gradient */}
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold mb-6">Tailored Solutions for Every Industry</h2>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              From startups to enterprises, we create custom web applications that solve real business challenges 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {solutions.map((solution, index) => (
              <div key={index} className="group relative p-8 rounded-3xl bg-gray-800/50 border border-gray-700/50 hover:border-gray-600 transition-all duration-500 overflow-hidden">
                ...
                {/* Content */}
                <div className="relative z-10">
                  <h3 className="text-2xl font-bold mb-4 text-white">{solution.category}</h3>
      ...
      <section className="py-24 bg-gray-900/70 backdrop-blur-sm">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold mb-6">Powered by Cutting-Edge Technology</h2>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              We leverage the latest technologies and frameworks to build applications that are not just 
              functional, but future-ready and built to scale.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {technologies.map((tech, index) => (
              <div key={index} className="group p-8 rounded-3xl bg-gray-800/50 border border-gray-700/50 hover:border-blue-400/50 transition-all duration-500 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {tech.technologies.map((technology, idx) => (
                    <span key={idx} className="px-3 py-1 bg-blue-500/20 text-blue-300 text-xs rounded-full border border-blue-400/30">
                      {technology}
                    </span>
                  ))}
                </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold mb-6">Our Proven Development Process</h2>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              A systematic approach that ensures quality, transparency, and successful delivery of your web application.
            </p>
          </div>
            ...
            {developmentProcess.map((phase, index) => (
              <div key={index} className="relative">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="text-cyan-400 text-sm font-semibold mb-3">{phase.duration}</div>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-500/20 via-cyan-500/20 to-teal-500/20 backdrop-blur-sm">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-bold mb-6">Ready to Build Something Extraordinary?</h2>
            <p className="text-xl text-gray-200 mb-10 leading-relaxed">
              Let's transform your vision into a powerful web application that drives results. 
              Schedule a consultation with our expert team and discover what's possible.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button 
